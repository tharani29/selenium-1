...
public class CustomElementLocator implements ElementLocator {
  ...
  public WebElement findElement() {
    ...
    if (element == null && !isOptionalElement) {
      throw new NoSuchElementException("Unable to locate elements with jQuery expression: " + jql.$());
    }
    return element;
  }
  ...
  public String toString() {
    if (annotations != null) {
      return "Attempting to find elements(s): " + annotations.buildBy() + "\tIs Optional IElement: " + isOptionalElement;
    }
    return "Attempting to find elements(s) with jQuery: " + jql.$() + "\tIs Optional IElement: " + isOptionalElement;
  }
}
