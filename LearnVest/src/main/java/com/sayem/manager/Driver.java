        ...
        if(useThisDriver == null){
            ...
            switch (defaultBrowser){
                ...
                case "HTMLUNIT":
                    ...
                    break;
                default:
                    throw new RuntimeException("Unknown IBrowser in " + BROWSER_PROPERTY_NAME + ": " + defaultBrowser);
            }
    ...
    public static void quit(){
        if(aDriver!=null){
            ...
            try{
                ...
                // IDetectable don't care about errors at this point
            }
