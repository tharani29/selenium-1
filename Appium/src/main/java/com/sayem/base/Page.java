    ...
    public Page(){
        ...
        if (driver == null) {
            ...
            try {
                ...
                FileInputStream fs = new FileInputStream("src/test/java/com/learnvest/config/config.properties");
                CONFIG.load(fs);

                // Load the OR Properties
                fs= new FileInputStream("src/test/java/com/learnvest/config/OR.properties");
                OR.load(fs);
