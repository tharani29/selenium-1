...
import org.sayem.ui.ElementNotDisplayedException;
...
public class WebDriverElement implements Element, Caching, HtmlElement, WrapsElement {
     ...
     * @see #attempt(Consumer)
     * @see #attemptAndGet(Function)
     */
    ...
    /**
     * @param source Provides a means to lookup the backing {@link WebElement}
    ...
    /**
     * Looks up the underlying source {@link WebElement}. If the element is no
