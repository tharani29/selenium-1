 ...
 * {@link Column}, which may also be thought of as
 ...
 * {@link Column}s. Otherwise, no content in your table would
 ...
 * have appropriately visible instances of {@link Column}
 ...
 * {@link ViewElement ViewElements}&mdash;they may behave as a
...
public interface Table<T extends Table<T>> extends ViewElement {
     ...
     *
     * <p>The iterable iterates over {@link Row} objects that
    ...
    /**
     * @return A specific {@link Row} for this table.
     */
    @SuppressWarnings("unchecked")
    ...
    /**
     * @return A specific {@link TableColumn} for this table.
     */
    @SuppressWarnings("unchecked")
    ...
    /**
     * @return A specific {@link HeadedTableColumn} for this
     * table.
     */
    @SuppressWarnings("unchecked")
    ...
    /**
     * @return A filtered {@link Stream} of the rows in this table where the
     * contents of a particular column match the specified {@link Predicate}.
     */
    ...
    /**
     * @return The first filtered {@link Optional} of the rows in this table where the
     * contents of a particular column match the specified {@link Predicate}.
     */
    ...
    /**
     * @return A filtered {@link Stream} of the rows in this table where the
     * contents of a particular column match the specified Hamcrest {@link Matcher}.
     */
    ...
    /**
     * @return Like
     * {@link #getRowsWhere(Column, Predicate)},
    ...
    /**
     * @return Like
     * {@link #getRowsWhere(Column, Matcher)},
     * except instead of returning a stream of rows, returns a stream of the exact cells that
