...
public interface PaginatedTable<T extends PaginatedTable<T>> extends Table<T> {
     ...
     * inclusive.
     * @return this
     * @throws IndexOutOfBoundsException if the page attempting to be navigated to is
     * greater than {@link #getMaxPages()}.
     */
    T toPage(int page);

    /**
     * @throws IndexOutOfBoundsException if {@link #hasPreviousPage()} is false.
     */
    T previousPage();

    /**
     * @throws IndexOutOfBoundsException if {@link #hasNextPage()} is false.
     */
    T nextPage();
