...
package org.sayem.ui.annotations;
...
/**
 * In it's most common usage, indicates a {@link Findable},
 * {@link Element}, {@link View}, or
 ...
 * {@link LoadConditionMatcher}.
 * <p>
 * It is best to annotate as many elements as possible or write a specific load condition via
 * overriding {@link View#isLoaded()} to ensure that every View's load
 * condition is unique.
 * <p>
 * For {@link ViewElement ViewElements}, these annotations also communicate
